...
void moveAutomation (const juce::Array<TrackAutomationSection>& origSections, double offsetToUse, bool copy)
{
    if (origSections.isEmpty())
        return;

    const auto offset = TimeDuration::fromSeconds (offsetToUse);
